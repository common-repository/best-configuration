...
namespace BestConfiguration\WPBones\View;
  ...
  public function render($asHTML = false)
  {
    ...
    // Use a php file
      ...
      $func = function () {
        ...
        if (!class_exists('BestConfiguration\Html')) {
          class_alias('\BestConfiguration\WPBones\Html\Html', 'BestConfiguration\Html', true);
        }
