...
namespace BestConfiguration\WPBones\Database;

use InvalidArgumentException;
use BestConfiguration\WPBones\Database\Support\Collection;
use BestConfiguration\WPBones\Database\Support\Model;
...
class QueryBuilder
{
   ...
   *
   * @var \BestConfiguration\WPBones\Database\Support\Collection
   */
  private $collection = [];
  ...
  */
   ...
   * @return \BestConfiguration\WPBones\Database\QueryBuilder
   */
