...
namespace BestConfiguration\WPBones\Foundation;

use Closure;
use BestConfiguration\WPBones\Container\Container;
use BestConfiguration\WPBones\Contracts\Foundation\Plugin as PluginContract;
use BestConfiguration\WPBones\Database\WordPressOption;
use BestConfiguration\WPBones\Foundation\Http\Request;
use BestConfiguration\WPBones\Foundation\Log\LogServiceProvider;
use BestConfiguration\WPBones\Routing\AdminMenuProvider;
use BestConfiguration\WPBones\Routing\AdminRouteProvider;
use BestConfiguration\WPBones\Routing\API\RestProvider;
use BestConfiguration\WPBones\Routing\Pages\PageProvider;
use BestConfiguration\WPBones\Support\Str;
use BestConfiguration\WPBones\Support\Traits\HasAttributes;
use BestConfiguration\WPBones\View\View;
...
/**
 * @class   Plugin
 * @package BestConfiguration\WPBones\Foundation
 *
...
class Plugin extends Container implements PluginContract
{
  ...
  public function boot(): Plugin
  {
    ...
    /*
         ...
         *
         ...
         Description = "BestConfiguration is a WP Bones boilperate plugin"
         DomainPath = "localization"
         Name = "BestConfiguration"
         Network = false
         PluginURI = "http://undolog.com"
         TextDomain = "best-configuration"
         Title = "BestConfiguration"
         Version = "1.0.0"
         */
   ...
   *
   * @return \BestConfiguration\WPBones\View\View
   */
  ...
  public function getCallableHook($routes)
  {
    ...
    if (isset($controller) && isset($method)) {
      return function () use ($controller, $method) {
        $className = "BestConfiguration\\Http\\Controllers\\{$controller}";
