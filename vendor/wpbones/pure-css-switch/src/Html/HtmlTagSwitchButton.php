...
namespace BestConfiguration\PureCSSSwitch\Html;

use BestConfiguration\WPBones\Html\HtmlTag;
...
<div
  class="wpbones-switch-button wpbones-switch-mode-<?php echo $mode; ?> wpbones-switch-button-<?php echo $this->theme; ?> <?php echo $disabled
   ? 'disabled'
   : ''; ?>">
