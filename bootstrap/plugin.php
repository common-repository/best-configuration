...
if (class_exists('\BestConfiguration\WPBones\Foundation\Plugin')) {
  $plugin = new \BestConfiguration\WPBones\Foundation\Plugin(realpath(__DIR__ . '/../'));
   ...
   */
  do_action('best-configuration_loaded');
